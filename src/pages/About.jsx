  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="carmaxxx, cars, deals, experts, free advice"
        />
      ...
      <main className="main-body">
        ...
        <section className="about-hero-container">
          <div className="about-hero-header">
            ...
            <p>
              With 50,000 CarMaxxx Quality Certified cars to choose
              from,there&apos;s a perfect match for your budget and life.
              Millions of cars are ruled out by our vetting process, and we
              never sell cars with flood damage, frame damage, or salvage
              history. Anything that doesn&apos;t meet our standards is repaired
              or replaced by our highly trained technicians.
            </p>
          </div>
        </section>
