            ...
            <main className="main-body">
                ...
                <section className='cars-container'>
                    ...
                    <div data-aos="fade-up" suppressHydrationWarning className="car-tabs-container">
                        <div onClick={() => { OpenModal(); setModalData("Toyota Hilux (2017)") }} data-aos="fade-up" suppressHydrationWarning className="car-tab-details">
                            <div className='box-design' />
                            <Image loading="lazy" as="image" width='250' height="250" alt='car-listing' src={hilux} />
                            <h6>Toyota Hilux (2017)</h6>
                        </div>

                        <div onClick={() => { OpenModal(); setModalData("Hyundai i30 (2018)") }} data-aos="fade-up" suppressHydrationWarning className="car-tab-details">
                            <div className='box-design' />
                            <Image loading="lazy" as="image" width='250' height="250" alt='car-listing' src={i30} />
                            <h6>Hyundai i30 (2018)</h6>
                        </div>
                        <div onClick={() => { OpenModal(); setModalData("Ford Ranger (2020)") }} data-aos="fade-up" suppressHydrationWarning className="car-tab-details">
                            <div className='box-design' />
                            <Image loading="lazy" as="image" width='250' height="250" alt='car-listing' src={ranger} />
                            <h6>Ford Ranger (2020)</h6>
                        </div>
                        <div onClick={() => { OpenModal(); setModalData("Toyota Corolla (2022)") }} data-aos="fade-up" suppressHydrationWarning className="car-tab-details">
                            <div className='box-design' />
                            <Image loading="lazy" as="image" width='250' height="250" alt='car-listing' src={corolla} />
                            <h6>Toyota Corolla (2022)</h6>
                        </div>
                        <div onClick={() => { OpenModal(); setModalData("Mitsubishi Triton (2021)") }} data-aos="fade-up" suppressHydrationWarning className="car-tab-details">
                            <div className='box-design' />
                            <Image loading="lazy" as="image" width='250' height="250" alt='car-listing' src={triton} />
                            <h6>Mitsubishi Triton (2021)</h6>
                        </div>
                        <div onClick={() => { OpenModal(); setModalData("Mazda CX-5 (2017)") }} data-aos="fade-up" suppressHydrationWarning className="car-tab-details">
                            <div className='box-design' />
                            <Image loading="lazy" as="image" width='250' height="250" alt='car-listing' src={cx5} />
                            <h6>Mazda CX-5 (2017)</h6>
                        </div>
                        <div onClick={() => { OpenModal(); setModalData("Toyota RAV4 (2019)") }} data-aos="fade-up" suppressHydrationWarning className="car-tab-details">
                            <div className='box-design' />
                            <Image loading="lazy" as="image" width='250' height="250" alt='car-listing' src={rav4} />
                            <h6>Toyota RAV4 (2019)</h6>
                        </div>
                        <div onClick={() => { OpenModal(); setModalData("Toyota Camry (2022)") }} data-aos="fade-up" suppressHydrationWarning className="car-tab-details">
                            <div className='box-design' />
