  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Find the best deals on cars and get expert advice for free. Carmaxxx offers a wide range of vehicles and unbeatable prices. Call us today!"
        />
        <meta
          name="keywords"
          content="carmaxxx, cars, deals, experts, free advice, best deals, cars under 1000"
        />
      ...
      <main className="main-body">
            ...
            <div className="nav-left-side">
              <div className="logo-container">
                <Image
                  ...
                  as="image"
                  onClick={() =>
                    setIsDisabled(isDisabled == "disabled" ? "" : "disabled")
                  }
                  className="menu-img"
                  width="25"
                  height="25"
        ...
        <section className="hero-container">
          ...
          <div className="hero-options">
            ...
            <motion.div
              ...
              transition={{ delay: 3, ease: [0.4, 0, 0.2, 1] }}
              className="hero-right-option"
            >
        ...
        <section className="cars-container">
          <div className="cars-heading">
            ...
            <h6>
              All listings are fetched in real time and all cars are in stock.
            </h6>
          </div>
          ...
          >
            <div
              onClick={() => {
                OpenModal();
                setModalData("Toyota Hilux (2017)");
              }}
              data-aos="fade-up"
              suppressHydrationWarning
              className="car-tab-details"
            >
            ...
            <div
              onClick={() => {
                OpenModal();
                setModalData("Toyota Corolla (2022)");
              }}
              data-aos="fade-up"
              suppressHydrationWarning
              className="car-tab-details"
            ...
            <div
              onClick={() => {
                OpenModal();
                setModalData("Mitsubishi Triton (2021)");
              }}
              data-aos="fade-up"
              suppressHydrationWarning
              className="car-tab-details"
            ...
            <div
              onClick={() => {
                OpenModal();
                setModalData("Toyota Camry (2022)");
              }}
              data-aos="fade-up"
              suppressHydrationWarning
              className="car-tab-details"
        ...
        <section className="testimonials-container">
          ...
          <div className="testimonial-container">
            <div data-aos="zoom-in" className="testimonial-tab">
              <h6>
                ~ Buying from carmaxxx was the best decision i made, top class
                quality
              </h6>
              <Image
                loading="lazy"
            ...
            <div data-aos="zoom-in" className="testimonial-tab">
              <h6>
                ~ Car is still running like the day i bought it from Carmaxxx ;{" "}
                {")"}
              </h6>
              <Image
                loading="lazy"
            ...
            <div data-aos="zoom-in" className="testimonial-tab">
              <h6>
                ~ 140,000 miles and counting! Amazing deal i got from Carmaxxx.
              </h6>
              <Image
                loading="lazy"
                as="image"
